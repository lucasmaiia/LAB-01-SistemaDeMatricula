...
| 14     | Sistema de Matrículas| Como sistema de matrículas, eu quero notificar o sistema de cobranças sobre as matrículas realizadas, para que os alunos sejam cobrados pelas disciplinas matriculadas.|
| 15     | Sistema de Matrículas| Como usuário do sistema, eu quero validar meu login utilizando minha senha, para que eu possa acessar minhas informações de forma segura.                             |
